...
## Exercise 6: [Develop a Node.js smart contract and web app for a Global Finance with blockchain use case](
https://github.com/IBM/global-financing-blockchain/blob/master/README.md) 
